...
class digitaltrends_content(manage):
    def __init__(self):
        self.data = []
        self.mn = manage('https://www.digitaltrends.com/gaming/')
        ...
        for i in r_external:
            try:
                ...
                pass
        self.ref_external =list(filter(('https://www.digitaltrends.com/gaming/').__ne__, self.s_external))
       
        # print(len(self.s_external))
        # print('++++++++++++',external)
        print('crawl done')
        pattern =  re.compile(r'(https://www.digitaltrends.com/gaming/)')
    ...
    def get_content(self,i):
        ...
        if len(soup.find_all('article',{'class': re.compile(r'(b-content b-single__content h-article-content)')}))  !=0:
            ...
            for k in soup.find_all('article',{'class': re.compile(r'(b-content b-single__content h-article-content)')}):
