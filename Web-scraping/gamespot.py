...
class gamespot_content(manage):
    def __init__(self):
        print('start crawl')
        self.data = []
        self.mn = manage('https://www.gamespot.com/')
        ...
        for i in r_external:
            try:
                ...
                pass
        self.ref_external =list(filter(('www.gamespot.com').__ne__, self.s_external))
    ...
    def get_content(self, i):
        ...
        for k in self.soup.find_all('section',{'class': re.compile(r'(article-body typography-format)')}):
