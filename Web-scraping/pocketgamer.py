...
class pocketgamer_content(manage):
    def __init__(self):
        self.data = []
        self.mn = manage('https://www.pocketgamer.com/')
        ...
        for i in r_external:
            try:
                ...
                pass
        self.ref_external =list(filter(('https://www.pocketgamer.com/').__ne__, self.s_external))
       
        # print(len(self.s_external))
        # print('++++++++++++',external)
        print('crawl done')
        pattern =  re.compile(r'(https://www.pocketgamer.com/)')
    ...
    def get_content(self,i):
        ...
        if len(soup.find_all('div',{'class': re.compile(r'(body-copy)')}))  !=0:
            ...
            for k in soup.find_all('div',{'class': re.compile(r'(body-copy)')}):
