...
class kotaku_content(manage):
    def __init__(self):
        self.data = []
        self.mn = manage('https://kotaku.com/')
        ...
        for i in r_external:
            try:
                ...
                pass
        self.ref_external =list(filter(('https://kotaku.com/').__ne__, self.s_external))
       
        # print(len(self.s_external))
        # print('++++++++++++',external)
        print('crawl done')
        pattern =  re.compile(r'(https://kotaku.com/)')
    ...
    def get_content(self,i):
        ...
        if len(soup.find_all('div',{'class': re.compile(r'(xs32fe-0 fRBTIs js_post-content)')}))  !=0:
            ...
            for k in soup.find_all('div',{'class': re.compile(r'(xs32fe-0 fRBTIs js_post-content)')}):
