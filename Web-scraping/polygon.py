...
class polygon_content(manage):
    def __init__(self):
        self.data = []
        self.mn = manage('https://www.polygon.com/')
        ...
        for i in r_external:
            try:
                ...
                pass
        self.ref_external =list(filter(('www.polygon.com').__ne__, self.s_external))
        print(Counter(self.ref_external))
        # print(len(self.s_external))
        # print('++++++++++++',external)
        print('crawl done')
        
        pattern =  re.compile(r'(https://www.polygon.com/\d{8}/)')
